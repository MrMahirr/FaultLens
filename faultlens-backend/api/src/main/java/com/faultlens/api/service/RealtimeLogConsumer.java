...
public class RealtimeLogConsumer {
    ...
    @org.springframework.kafka.annotation.KafkaListener(topics = "log-errors", groupId = "faultlens-api-realtime", containerFactory = "logEntryKafkaListenerContainerFactory")
    public void consume(com.faultlens.common.dto.LogEntryDto entry) {
